...
public interface PasswordEncryptor {
    ...
    boolean checkPassword(AuthenticationData authenticationData, RegisteredUserData registeredUserData) throws NoSuchAlgorithmException, NoSuchProviderException;
